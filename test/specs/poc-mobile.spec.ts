...
pocCase1
    ...
    describe(`TC:${testCase.testCase} Create the booking on USER side =>`, () => {
        ...
        describe('AddonsPage => ', () => {
            ...
            if (testCase.addonPageOptions.secondaryDriver != undefined ){
                it('Set Secondary driver =>' , async () => {
                    await BookingAddonsPage.withSecondaryDriver.scrollIntoView({ block: 'center', inline: 'center' });
        ...
        it('PaymentDetailsPage => ', async () => {
            ...
            //await CarDetailsPage.termsAndConditionsCheckbox.visiblityClick( {waitForDisplayedTimeout : 4000, pauseTime : 4000});
            (await $("//p[text()='I agree to']//following-sibling::div//input//parent::label//parent::div")).visiblityClick();
